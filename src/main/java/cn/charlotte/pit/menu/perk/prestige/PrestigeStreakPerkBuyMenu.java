 ...
 */
public class PrestigeStreakPerkBuyMenu extends Menu {
    private int page = 0;

    public PrestigeStreakPerkBuyMenu() {
    }


    @Override
    public String getTitle(Player player) {
        return "连杀 (第" + (page + 1) + "页)";
    }
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        perks.removeIf(perk -> perk.getShopPerkType() != ShopPerkType.STREAK);
