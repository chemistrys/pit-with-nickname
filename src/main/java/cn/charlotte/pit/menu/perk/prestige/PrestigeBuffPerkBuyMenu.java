 ...
 */
public class PrestigeBuffPerkBuyMenu extends Menu {
    private int page = 0;

    public PrestigeBuffPerkBuyMenu() {
    }


    @Override
    public String getTitle(Player player) {
        return "天赋 (第" + (page + 1) + "页)";
    }
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        perks.removeIf(perk -> perk.getShopPerkType() != ShopPerkType.BUFF);
