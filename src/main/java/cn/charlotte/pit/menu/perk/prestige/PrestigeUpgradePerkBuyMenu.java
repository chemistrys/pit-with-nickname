 ...
 */
public class PrestigeUpgradePerkBuyMenu extends Menu {
    private int page = 0;

    public PrestigeUpgradePerkBuyMenu() {
    }


    @Override
    public String getTitle(Player player) {
        return "升级 (第" + (page + 1) + "页)";
    }
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        perks.removeIf(perk -> perk.getShopPerkType() != ShopPerkType.UPGRADE);
